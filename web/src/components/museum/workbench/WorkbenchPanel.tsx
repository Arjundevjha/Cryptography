    ...
    >
      ...
      <div className="mb-4">
        ...
        <textarea
          ...
          className="w-full px-3 py-2 rounded-lg bg-stone-900 border border-stone-800 text-stone-100 text-xs font-mono focus:outline-none focus:ring-2 focus:ring-amber-500 transition-all"
        />
      </div>
