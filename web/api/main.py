...
# Security: Defense-in-depth middleware adding standard HTTP security headers to all FastAPI responses
@app.middleware("http")
...
def _decode_aes_key(key: str, key_format: str) -> bytes:
    ...
    if key_format == "hex":
        try:
            ...
            raise HTTPException(status_code=400, detail="Invalid hex key") from exc
