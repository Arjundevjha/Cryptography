...
## Corpus Check
- 113 files · ~70,424 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1145 nodes · 2006 edges · 69 communities (57 shown, 12 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 157 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ef0458ed`
...
Cohesion: 0.09
Nodes (51): BaseModel, Lorenz, Lorenz SZ40/SZ42 cipher machine orchestrator., Compute the SHA-256 hash of the given data.      Args:         data: The input s, sha256(), Request, RequestValidationError, aes_decrypt_endpoint() (+43 more)
...
Cohesion: 0.19
Nodes (3): Get current position indices for all 12 wheels., Set manual pin configurations for Chi, Motor, and Psi wheels.          Args:, VercelPathMiddleware
