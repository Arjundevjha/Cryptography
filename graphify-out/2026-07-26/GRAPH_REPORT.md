...
## Corpus Check
- 108 files · ~58,355 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1064 nodes · 1885 edges · 62 communities (51 shown, 11 thin omitted)
...
- SHA-256 Hash Backend Endpoint & Model
...
Cohesion: 0.10
Nodes (45): BaseModel, Lorenz, Lorenz SZ40/SZ42 cipher machine orchestrator., Set manual pin configurations for Chi, Motor, and Psi wheels.          Args:, aes_decrypt_endpoint(), aes_encrypt(), AesDecryptInput, AesEncryptInput (+37 more)
...
Cohesion: 0.11
Nodes (18): Reflector component for Enigma machine., Reflect a signal back through the rotors., Get the current reflector wiring mapping., Reflector simulator for reversing signal direction in Enigma., Initialize the reflector with standard and custom wiring mapping., Reflector, Test the reflecting logic of the Reflector., Test reflecting logic on all characters. (+10 more)
...
### Community 38 - "SHA-256 Hash Backend Endpoint & Model"
Cohesion: 0.33
Nodes (6): enigma_encipher(), EnigmaEncipherInput, parse_and_validate_enigma_rings(), validate_enigma_plugboard(), validate_enigma_positions(), validate_enigma_rotors()
...
- **Why does `Lorenz` connect `FastAPI Backend Routes & Schema Models` to `Lorenz Text Processing Procedures`, `Lorenz Machine Core Unit Tests`, `Lorenz Machine Pinwheels Initialization`, `Lorenz Interactive CLI Simulation Runner`, `SHA-256 Hash Backend Endpoint & Model`, `Baudot ITA2 Lorenz Code Conversions`, `Lorenz Wheels Components Testing`, `Lorenz Stepping Controller Engine`, `Enigma Keyboard Component Routing`, `Enigma Plugboard Component Routing`, `Enigma Reflector Simulator Routing`, `Lorenz Machine Cryptography Vector Math`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `Reflector` connect `Enigma Reflector Simulator Routing` to `FastAPI Backend Routes & Schema Models`, `SHA-256 Hash Backend Endpoint & Model`, `Enigma Cipher Machine Implementation`, `Enigma Rotor Mechanics Simulation`, `Enigma Plugboard Component Routing`?**
