# Graph Report - Cryptography  (2026-08-30)

## Corpus Check
- 110 files · ~61,252 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1116 nodes · 1957 edges · 70 communities (58 shown, 12 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 157 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `60f8a3d8`
...
Cohesion: 0.09
Nodes (31): Historical cryptography methods package., decrypt(), encrypt(), main(), pick_keys(), Polybius Square cipher implementation., Encrypt plaintext using the Polybius Square cipher.      Maps each letter to a t, Decrypt ciphertext using the Polybius Square cipher.      Parses two-digit coord (+23 more)
...
Cohesion: 0.21
Nodes (17): decrypt(), encrypt(), main(), pick_keys(), Scytale transposition cipher implementation., Encrypt plaintext using the Scytale cipher.      Pads the plaintext and performs, Decrypt ciphertext using the Scytale cipher.      Reverses the column-wise trans, Run an interactive test of the Scytale cipher. (+9 more)
...
Cohesion: 0.13
Nodes (26): Classical cryptography methods package., test_decrypt(), test_decrypt_unmatching_length_and_edge_cases(), test_encrypt(), test_encrypt_decrypt_char(), test_encrypt_decrypt_roundtrip(), test_encrypt_unmatching_length_and_edge_cases(), test_main_custom_key() (+18 more)
...
Cohesion: 0.11
Nodes (17): Main simulation runner for the Enigma machine., Rotor component for Enigma machine., Pass the signal forward from right side to left side of the rotor., Pass the signal backwards from left side to right side of the rotor., Rotate the rotor n steps forward or backward., Rotate the rotor until the specified letter is at the top position., Set the ring offset for the rotor, adjusting notch and wiring., Rotor simulator representing a rotating scrambled wheel. (+9 more)

### Community 27 - "Enigma Reflector Simulator Routing"
Cohesion: 0.10
Nodes (21): Reflector component for Enigma machine., Reflect a signal back through the rotors., Get the current reflector wiring mapping., Reflector simulator for reversing signal direction in Enigma., Initialize the reflector with standard and custom wiring mapping., Reflector, Test the reflecting logic of the Reflector., Test reflecting logic on all characters. (+13 more)
...
## Knowledge Gaps
- **118 isolated node(s):** `run_e2e_no_install.sh script`, `PYTHONPATH`, `run_e2e_tests.sh script`, `PYTHONPATH`, `run_tests.sh script` (+113 more)
