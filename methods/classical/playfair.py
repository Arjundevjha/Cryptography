...
def _build_transform_map(
    ...
    branching, modulo arithmetic, and 2D grid index lookups inside the character loop
    with a single O(1) table lookup.
    """
...
def encrypt(plaintext: str, key: str) -> str:
    ...
    try:
        ...
        raise ValueError(f"Character {missing_char} not found in grid") from e
